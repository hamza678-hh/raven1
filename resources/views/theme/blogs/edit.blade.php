...
@section('content')
    ...
    @include('theme.partials.hero', ['tittle' => $blog->name])
                    ...
                    <form action="{{ route('blogs.update', ['blog' => $blog]) }}" class="form-contact contact_form"
                        ...
                        <div class="form-group">
                            <input class="form-control border" name="name" type="text"
                                placeholder="Enter your blog tittle" value="{{ $blog->name }}">
                        ...
                        <div class="form-group">
                            <select class="form-control border" name="category_id" type="text"
                                placeholder="Enter your blog tittle" value="{{ old('category_id') }}">
                        ...
                        <div class="form-group">
                            <textarea class="w-100 border" name="description"  placeholder="Enter your blog dsscriptiion"
                                rows="5" value="{{ $blog->description }} " style="color: black; " >
                            </textarea>
